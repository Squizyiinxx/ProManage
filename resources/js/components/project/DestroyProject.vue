        ...
        <template #contentMain>
            <form @submit.prevent="submit">
                <div class="flex flex-col gap-4">
                    <h2 class="text-primary text-lg font-semibold">Delete Project</h2>
                    <p class="text-muted-foreground text-sm text-pretty">Are you sure you want to delete the project "{{ props.project.name }}"?</p>
